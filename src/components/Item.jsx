...
const Item = ({ task }) => {
  ...
  const handleDeleteItem = async () => {
    ...
    try {
      // umwrap() : 비동기 함수의 await 값이 인식 안될 때 사용(ex: dispatch)
  ...
  const changeCompleted = async () => {
    ...
    try {
      await dispatch(fetchUpdatedCompletedData(updateCompleted)).unwrap();
      newIsCompleted
      ...
      console.errer("Update Completed Error: " + error);
    }
  };
